...
import { Button, Text } from '@kebbeswapfinance-libs/uikit'
  ...
  return (
    <Page>
      ...
      <Content>
        <div>
          <Block>
            <Title as="h2">{TranslateString(999, 'Coming Soon to KebbeSwap.')}</Title>
            <Text mb={3}>
              {TranslateString(
                504,
          ...
          <Block>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with KebbeSwap, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
