...
import { Image, Heading, RowType, Toggle, Text } from '@kebbeswapfinance-libs/uikit'
  ...
  return (
    <>
      ...
      <Page>
        ...
        {renderContent()}
        <StyledImage src="/images/kebbe-square.png" alt="KEBBE illustration" width={120} height={120} />
      </Page>
    </>
  )
}
